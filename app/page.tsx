export default function Home() {
  return (
    <main className="flex min-h-screen">
      ...
      <div className=''>
        <img src="/can.svg" className='z-20 translate-y-[66vh] -translate-x-[16vw] md:translate-y-[30vh]  md:translate-x-[38vw] 2xl:translate-x-[60vw] fixed' />
        ...
        <img src="/blueberry.svg" className='hidden md:block z-10 translate-y-[45vh] md:translate-x-[45vw] 2xl:translate-x-[63vw] fixed' />
        <img src="/blueberry.svg" className='hidden md:block z-10 translate-y-[45vh] md:translate-x-[25vw] 2xl:translate-x-[23vw] fixed' />
        <img src="/blueberry.svg" className='hidden md:block z-10 translate-y-[30vh] md:translate-x-[30vw] 2xl:translate-x-[33vw] fixed' />
      </div>

      <div className='flex flex-col w-screen h-screen justify-center items-center align-middle z-20 -translate-x-[20vw] text-center md:p-10 '>
        ...
        <br />
        <a href='/store' className='text-center rounded-md bg-sky-800 border-white shadow-gray-900 justify-center align-middle items-center flex text-slate-100 max-w-36 px-5 py-2 shadow-md'>
          Shop Now
        </a>
      </div>
    </main>
